...
export default function NavBar() {
  ...
  return (
    <div className="navbar bg-transparent w-[90%] mx-auto sticky z-20">
      <div className="navbar-start items-center">
        <a className="flex justify-center items-center mr-10">
          <svg
            width="37"
            height="38"
            viewBox="0 0 37 38"
          ...
          <div className="">
            <span className="text-3xl font-semibold white">Restau</span>
            <span className="text-3xl text-white">rant</span>
          </div>
        </a>
        <div className="hidden lg:flex">
          <ul className="menu menu-horizontal px-1 flex-nowrap">{navMenu}</ul>
        </div>
      </div>

      <div className="navbar-end">
        <a className="bg-yellow px-6 py-[10px] font-roboto text-base font-bold lg:block hidden">
          Button
        </a>
        <div className="dropdown ">
          <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
            ...
            >
              <path
                d="M21 9.5H1C0.448 9.5 0 9.052 0 8.5C0 7.948 0.448 7.5 1 7.5H21C21.552 7.5 22 7.948 22 8.5C22 9.052 21.552 9.5 21 9.5ZM22 1.5C22 0.948 21.552 0.5 21 0.5H1C0.448 0.5 0 0.948 0 1.5C0 2.052 0.448 2.5 1 2.5H21C21.552 2.5 22 2.052 22 1.5ZM22 15.5C22 14.948 21.552 14.5 21 14.5H1C0.448 14.5 0 14.948 0 15.5C0 16.052 0.448 16.5 1 16.5H21C21.552 16.5 22 16.052 22 15.5Z"
                fill="white"
              />
            </svg>
          </div>
